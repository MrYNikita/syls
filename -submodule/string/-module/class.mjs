...
import { positionCorrect } from '@syls/many/position';
import { yClassifyProp, yGetProperty } from '@syls/y';
import { condIsNumberLimit, condIsStringValid } from '@syls/y/cond';

import { YANSI } from '../-submodule/ansi/-module/export.mjs';
import { YLayout } from '../-submodule/layout/-module/export.mjs';
import { YTemplate } from '../-submodule/template/-module/class.mjs';
    ...
    */
    ...
    static #create(t) {
        ...
        this
            ...
            .appendCursors([0, this.values.length])
            .paste(t.value);
